 ...
 */
export function getLowPassFIRCoeffs(sampleRate, halfAmplFreq, length) {
  length += (length + 1) % 2;
 ...
 */
export function multiplyArray(samples, sampleRate, freq, cosine) {
 ...
 */
export function getHilbertCoeffs(length, upper) {
  length += (length + 1) % 2;
  var center = Math.floor(length / 2);
 ...
 * @constructor
 */
export function FIRFilter(coefficients) {
 ...
 * @constructor
 */
export function Downsampler(inRate, outRate, coefficients) {
 ...
 * @constructor
 */
export function SSBDemodulator(inRate, outRate, filterFreq, upper, kernelLen) {
 ...
 * @constructor
 */
export function AMDemodulator(inRate, outRate, filterFreq, kernelLen) {
 ...
 * @constructor
 */
export function FMDemodulator(inRate, outRate, maxF, filterFreq, kernelLen) {
 ...
 * @constructor
 */
export function StereoSeparator(sampleRate, pilotFreq) {
  var AVG_COEF = 9999;
  var STD_THRES = 400;
 ...
 * @constructor
 */
export function Deemphasizer(sampleRate, timeConstant_uS) {
 ...
 * @constructor
 */
export function ExpAverage(weight, opt_std) {
  var avg = 0;
  var std = 0;
 ...
 */
export function iqSamplesFromUint8(buffer, rate) {
 ...
 */
export function shiftFrequency(IQ, freq, sampleRate, cosine, sine) {
